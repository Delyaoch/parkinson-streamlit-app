...
with st.sidebar:
    ...
    st.info(
        "Приложение разработано для анализа голосовых характеристик."
        "и демонстрации возможностей машинного обучения при работе с данными о болезни Паркинсона. "
    )
    ...
    st.caption(
        "Проект выполнен в учебных целях. Полученные результаты не являются медицинским заключением и не предназначены для постановки диагноза."
    )
